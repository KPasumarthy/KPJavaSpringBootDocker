...
import com.kpjavaspringboot.interview.KPFibonassi;
...
public class KPFibonassiTest {
    ...
    void test1CreateFibonacciSeries() {
        ...
        KPFibonassi.createFibonacciSeries();
    }
    ...
    void test2CreateFibonacciNSeries() {
        ...
        int n = 20;
        KPFibonassi.createFibonacciNSeries(n);
    }
    ...
    void test4CreateFibonacciNSeriesAsDouble() {
        ...
        double n = 100;
        KPFibonassi.createFibonacciNSeriesAsDouble(n);
    }
}
